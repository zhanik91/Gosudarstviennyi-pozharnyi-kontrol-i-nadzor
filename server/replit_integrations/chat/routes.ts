...
- Определении категорий помещений А, Б, В1-В4, Г, Д
- Нормативах НГПС (негосударственной противопожарной службы) и ПСС (пожарно-спасательных служб)

Отвечайте на русском языке, давайте точные ссылки на НПА РК. Предоставляйте практические рекомендации и формулы расчетов при необходимости.`;
...
export function registerChatRoutes(app: Express): void {
  ...
  app.post("/api/conversations/:id/messages", async (req: Request, res: Response) => {
    try {
      ...
      // Stream response from OpenAI with system prompt
