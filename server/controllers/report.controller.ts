  ...
  switch (form) {
    ...
    case 'co': // Form 7-CO
      ...
      if (row5Total !== row5Sum) {
         errors.push({ field: '5.killed_total', message: `Строка 5: итог по погибшим должен равняться сумме подпунктов 5.1–5.11 (${row5Sum}), сейчас ${row5Total}.` });
      }
      ...
      if (row6Total !== row6Sum) {
         errors.push({ field: '6.killed_total', message: `Строка 6: итог по погибшим должен равняться сумме подпунктов 6.1–6.15 (${row6Sum}), сейчас ${row6Total}.` });
      }
      ...
      if (row15Total !== row15Sum) {
         errors.push({ field: '15.injured_total', message: `Строка 15: итог по травмированным должен равняться сумме подпунктов 15.1–15.11 (${row15Sum}), сейчас ${row15Total}.` });
      }
      ...
      if (row16Total !== row16Sum) {
         errors.push({ field: '16.injured_total', message: `Строка 16: итог по травмированным должен равняться сумме подпунктов 16.1–16.15 (${row16Sum}), сейчас ${row16Total}.` });
      }
      break;
